...
<head>
    ...
    <link rel="stylesheet" href="${basePath}/static/content/adminlte/dist/css/skins/_all-skins.css">
...
<header class="main-header">
    ...
    <a href="" class="logo">
        ...
        <span class="logo-mini"><b>猿</b>商</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>猿</b>商</span>
    </a>
            ...
            <ul class="nav navbar-nav">
                            ...
                            <ul class="menu">
                                <li>
                                    ...
                                    <a href="#">
                                        <div class="pull-left">
                                            <!-- User Image -->
                                            <img src="${basePath}/static/content/ui/img/photos/girl1.png" class="img-circle" alt="User Image">
                                        </div>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="${basePath}/static/content/ui/img/photos/girl1.png" class="user-image" alt="User Image">
    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left image">
                <img src="${basePath}/static/content/ui/img/photos/girl1.png" class="img-circle" alt="用户头像">
            </div>
